...
Finally, after assembling the sensor to ESP32 and Creting Linux VM in VirtualBox, it is necessary to compile and upload link:ESP32_Mqtt_NodeRed_Influx_Grafana/[the provided Sketch code] to ESP32.
It is up to you to connect ESP32 (SSID IoT_ES) to the provided Wi-Fi AP embedded with MQTT Broker. As you wish, you can connect ESP32 to your Wi-Fi AP and another MQTT Broker server. 
