...
It is up to you to connect ESP32  to the provided Wi-Fi AP (SSID "IoT_ES") embedded with the MQTT Broker. As you wish, you can connect ESP32 to your Wi-Fi AP and another MQTT Broker server. 
