...
**Note**: For guidance on integrating the ESP32 to an Linux Virtual Machine server Featuring Node-Red, InfluxDB, and Grafana, consider watching this instructional video on image::../../../images/youtube.jpg[youtube, link="https://www.youtube.com/watch?v=_DO2wHI6JWQ", width="80", height="17"]
